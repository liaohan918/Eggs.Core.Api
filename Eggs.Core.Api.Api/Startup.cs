...
using Eggs.Core.Api.Extensions;
using Eggs.Core.Api.Filter;
using Eggs.Core.Api.Hubs;
using Eggs.Core.Api.IServices;
using Eggs.Core.Api.Middlewares;
using Eggs.Core.Api.Model.Seed;
using Eggs.Core.Api.Tasks;
...
namespace Eggs.Core.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("Eggs.Core.Api.Api.index.html"));
