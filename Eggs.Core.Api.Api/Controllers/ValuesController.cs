...
using AutoMapper;
using Eggs.Core.Api.Common.HttpContextUser;
using Eggs.Core.Api.Common.HttpRestSharp;
using Eggs.Core.Api.Common.WebApiClients.HttpApis;
...
namespace Eggs.Core.Api.Controllers
{
    /// <summary>
    /// Values控制器
    /// </summary>
